...
const Home = () => {
  ...
  return <>
    ...
    <useForm.View  responsiveSize={{ col: 4 }} responsive={{ lg: 8, md: 8, sm: 8, xl: 8, xs: 8 }}>
      <WebApi.Button ref={ref2} label="btn1 HIDE" icon={{ iconName: WebApi.IconName.AlignJustify }}
        onClick={() => {
      ...
      <WebApi.Button ref={ref2} label="GETDATA" icon={{ iconName: WebApi.IconName.AlignJustify }}
        onClick={() => {
          console.log(form.current?.getValues());
        }} />
      <WebApi.Button ref={ref2} label="isValid" icon={{ iconName: WebApi.IconName.AlignJustify }}
        onClick={() => {
